...
(function($) {
  ...
  $.formValidator.defaults = {
    ...
    errorDiv    : '#warn',
    errorMsg    :   {
                reqString   : 'Campos obrigatórios',
                reqDate     : 'Data inválida!',
                reqNum      : 'Sadece sayı girebilirsiniz',
                reqMailNotValid : 'E-mail inválido!',
                reqMailEmpty  : 'E-mail requirido',
                reqSame     : 'Confirmação de senha inválida!',
                reqBoth     : 'İlgili alanları doldurmalısınız!',
                reqMin      : 'Mínimo de %1 caracteres'
              },
    customErrMsg  : '',
